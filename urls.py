...
urlpatterns = patterns('',
    ...
    (r'^product_groups/manufacturers/(?P<manufacturer_id>\d+)/$', quote_generator.views.products),
    (r'^product_groups/categories/(?P<category_id>\d+)/$', quote_generator.views.products),
